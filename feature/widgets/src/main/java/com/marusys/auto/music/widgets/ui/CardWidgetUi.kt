...
import com.marusys.auto.music.widgets.NextSongAction
import com.marusys.auto.music.widgets.PreviousSongAction
import com.marusys.auto.music.widgets.R
import com.marusys.auto.music.widgets.TogglePlaybackAction
...
fun CardWidgetUi(
    ...
    Row(
        modifier = GlanceModifier.fillMaxWidth().height(100.dp).background(Color.White)
            .clickable(actionStartActivity(ComponentName(context, "com.marusys.auto.music.MainActivity"))),
...
fun Image(
    ...
    val provider =
        if (bitmap == null)
            ImageProvider(com.marusys.auto.music.ui.R.drawable.placeholder)
        else
