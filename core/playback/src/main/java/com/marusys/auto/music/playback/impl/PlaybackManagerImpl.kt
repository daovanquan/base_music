package com.marusys.auto.music.playback.impl
...
class PlaybackManagerImpl: PlaybackManager() {
    ...
    private fun updateQueue() {
        ...
        val queueItems = (0 until count).mapNotNull { i ->
            ...
            val filePath = requestMetadata.extras?.getString(EXTRA_SONG_FILE_PATH, null)
            val song = (if(filePath != null) songsLibrary.getSongByPath(filePath) else null) ?: (songsLibrary.getSongByUri(requestMetadata.mediaUri.toString())
